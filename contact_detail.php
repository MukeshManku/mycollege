...
if (isset($_GET['del'])) {
	...
	$sql = "DELETE FROM contact_us WHERE id=$id";
     ...
     echo '<script language="javascript">alert("Contact Detail record Delete Succesfully !!!")</script>';
    echo '<script language="javascript">window.location = "contact_detail.php"</script>';
}
...
<body>
  ...
  <div style="margin-top:20px;" id="recordheding">
      <h1><a href="Admin.php">CONTACT US RECORDS</a></h1>
  </div> 
    <div id="clear"></div>
             ...
             <?php while ($row = mysqli_fetch_array($results)) { ?>
                <tr>
					...
					<td><?php echo $row['massege'] ?></td>
                       ...
                       <td><a href="contact_detail.php?del=<?php echo $row['id']; ?>" class="del_btn">Delete</a></td>
