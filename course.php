...
$results = mysqli_query($conn, "SELECT * FROM course");
...
if (isset($_GET['del'])) {
    ...
    //header('location: course.php');
     ...
     echo '<script language="javascript">alert("Course Record Delete Sucessfully !!!")</script>';
        echo '<script language="javascript">window.location = "course.php"</script>';
}
...
<body>
  ...
  <div style="margin-top:20px;" id="recordheding">
    ...
    <div id="clear"></div>
     ...
     <div id="record1">
        <h2><a style="color:white;" href="course.php">View Course</a> | <a style="color:white;" href="add_course.php">Add Course</a></h2>
        <table>
           <thead>
              <tr>
                  <th>ID</th>
             ...
             <?php while ($row = mysqli_fetch_array($results)) { ?>
                <tr>
                    ...
                    <td><?php echo $row['coursetype'] ?></td>
                       ...
                       <td><a href="course.php?del=<?php echo $row['course_id']; ?>" class="del_btn">Delete</a></td>
