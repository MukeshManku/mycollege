...
$results = mysqli_query($conn, "SELECT * FROM subject");
...
if (isset($_GET['del'])) {
	...
	$sql = "DELETE FROM subject WHERE subject_id=$id";
     ...
     echo '<script language="javascript">alert("Subject Record Delete Sucessfully !!!")</script>';
        echo '<script language="javascript">window.location = "view_course.php"</script>';
}
...
<body>
  ...
  <div style="margin-top:20px;" id="recordheding">
    ...
    <div id="clear"></div>
     ...
     <div id="record1">
        <h2><a style="color:white;" href="view_course.php">View Subject</a> | <a style="color:white;" href="add_subject.php">Add Subject</a></h2>
        <table>
           <thead>
              <tr>
                  <th>ID</th>
				  <th>SEMESTER</th>
				  <th>SUBJECT SHORT FORMS</th>
                  <th>SUBJECT</th>
                  <th>ACTION</th>
             ...
             <?php while ($row = mysqli_fetch_array($results)) { ?>
                <tr>
					...
					<td><?php echo $row['subject_name'] ?></td>
                       ...
                       <td><a href="view_course.php?del=<?php echo $row['subject_id']; ?>" class="del_btn">Delete</a></td>
