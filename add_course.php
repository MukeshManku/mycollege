...
{
	$sql="INSERT INTO course(coursename, coursetype, status) VALUES ('$_POST[coursename]','$_POST[coursetype2]','Active')";
...
<body>
  ...
  <div style="margin-top:20px;" id="recordheding">
      <h1><a href="Admin.php">COURSE RECORDS</a></h1>
  </div> 
    <div id="clear"></div>
   ...
   <div id="cantantsubject">
      ...
      <div id="addsubject" class="two_third"> 
        ...
        <h2><a href="course.php">View Course</a> | <a href="time_table_admin.php">Add Time Table</a></h2>
   ...
   <tr>
    ...
    <td><input style="padding:3px; width:250px;" type="text" placeholder="Short Course Name..." name="coursename" id="coursename"></td>
  </tr>
  
  
  <tr>
    <td height="38">Course Name </td>
    <td><input style="padding:3px; width:250px;" type="text" placeholder="Full Course Name..."  name="coursetype2" id="coursetype2"></td>
  </tr>
