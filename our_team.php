...
<body>
    ...
    <div id="clear"></div>
      ...
      <h1><a href="#">OUR TEAM</a></h1>
          ...
          <div id="our_team_contener">
        <div id="our_team_line1">
    <div id="our_team">
       <img src="image/our_team/ranjan.jpg" width="200px" height="200px">
        <div id="team">
           <h2>Mr. Ranjan Kumar </h2> 
           <h2>Designing & Developer</h2> 
            
        </div>
        
    </div>
     <div id="our_team">
       <img src="image/Admin2.png" width="200px" height="200px">
        <div id="team">
           <h2>Mr. Ranjan Kumar </h2> 
           <h2>Maintaining & Designing</h2> 
